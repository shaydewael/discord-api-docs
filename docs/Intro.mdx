...
Start learning by exploring more about apps on Discord, find inspiration from successful developers, or jump right into building.
...
<Container>
  ...
  <Card title="Developer Case Studies" link="https://discord.com/build#case-studies" icon="MicrophoneIcon">
