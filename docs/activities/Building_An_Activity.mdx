...
- An understanding of what Discord [Activities](#DOCS_ACTIVITES_OVERVIEW) are
...
- Updated your `client/main.js` code to fetch the guild information using the [`GET /users/@me/guilds`](#DOCS_RESOURCES_USER/get-current-user-guilds) API endpoint
- Added a call to the new function in the callback for `setupDiscordSdk()`
</Collapsible>
...
<Container>
  ...
  <Card title="Sample Activity Projects" link="https://github.com/discord/embedded-app-sdk-examples" icon="GithubNeutralIcon">
